...
const initApiRoutes = (app) => {
    ...
    // Dashboard routes
    router.get('/getTotalUsers', dashboardController.getTotalUsers);
    router.get('/getPlanStats', dashboardController.getPlanStats);
    router.get('/getUserRoleStats', dashboardController.getUserRoleStats);
    router.get('/getSubscriptionStats', dashboardController.getSubscriptionStats);
    router.get('/getGenderStats', dashboardController.getGenderStats);
